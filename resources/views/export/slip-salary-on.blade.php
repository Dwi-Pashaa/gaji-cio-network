...
<body>
    ...
    <table class="salary">
        ...
        <tbody>
            ...
            <tr>
                <td colspan="2"><strong>Absensi</strong></td>
            </tr>

            <tr>
                <td>Potongan Tidak Hadir</td>
                <td class="text-right">{{ number_format($potongan_alpa * $alpha, 0, ',', '.') }}</td>
            </tr>
            <tr>
                <td>Potongan Izin/Cuti</td>
                <td class="text-right">{{ number_format($potongan_cuti * $cuti, 0, ',', '.') }}</td>
            </tr>
            <tr>
                <td>Potongan Terlambat</td>
                <td class="text-right">{{ number_format($potongan_telat * $telat, 0, ',', '.') }}</td>
            </tr>
            <tr>
                <td><strong>Total Potongan Absensi</strong></td>
                <td class="text-right"><strong>{{ number_format($attendancePenalty, 0, ',', '.') }}</strong></td>
            </tr>
        </tbody>
        <tfoot>
            <tr>
