{{-- SISI KARYAWAN: OFF ABSENSI (SLIP GAJI STANDAR) --}}
    ...
    <div class="card-header bg-white py-3 border-bottom d-flex align-items-center justify-content-between">
        <div>
            <h3 class="card-title fw-bold text-dark mb-0 d-flex align-items-center gap-2">
                ...
                Riwayat Pembayaran Gaji Bulanan
            </h3>
            <p class="text-muted small mb-0">Daftar arsip penggajian, status transfer, dan unduh slip gaji</p>
        </div>
