    ...
    <div class="card">
                ...
                <tbody>
                    @forelse ($leaves as $item)
                        <tr>
                            ...
                            <td>
                                @canany(['edit pengajuan izin/cuti', 'hapus pengajuan izin/cuti'])
                                    ...
                                    @endif
                                @endcanany
                                @canany(['approved pengajuan izin/cuti', 'rejected pengajuan izin/cuti'])
                                    @if ($item->status === "pending")
                                        <a href="javascript:void(0)" onclick="return approved('{{ $item->id }}')" class="btn btn-outline-warning btn-md">
                                            <svg  xmlns="http://www.w3.org/2000/svg"  width="24"  height="24"  viewBox="0 0 24 24"  fill="none"  stroke="currentColor"  stroke-width="2"  stroke-linecap="round"  stroke-linejoin="round"  class="icon icon-tabler icons-tabler-outline icon-tabler-edit"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M7 7h-1a2 2 0 0 0 -2 2v9a2 2 0 0 0 2 2h9a2 2 0 0 0 2 -2v-1" /><path d="M20.385 6.585a2.1 2.1 0 0 0 -2.97 -2.97l-8.415 8.385v3h3l8.385 -8.415z" /><path d="M16 5l3 3" /></svg>
                                            Approved
                                        </a>
        ...
        <div class="card-footer d-flex align-items-center">
            <p class="m-0 text-secondary">
                Showing <span>{{ $leaves->firstItem() }}</span> 
                to <span>{{ $leaves->lastItem() }}</span> of
                <span>{{ $leaves->total() }}</span> entries
            </p>
        ...
        <div class="modal-dialog modal-1 modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Ajukan Permohonan Izin/Cuti</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group mb-3">
                        <label for="tipe" class="mb-2">Tipe Izin/Cuti</label>
                        ...
                        <span class="invalid-feedback error_tipe"></span>
                    </div>
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="form-group mb-3">
                                <label for="start_date" class="mb-2">Tanggal Dimulai</label>
                                <input type="date" name="start_date" id="start_date" class="form-control">
                                <span class="invalid-feedback error_start_date"></span>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group mb-3">
                                ...
                                <span class="invalid-feedback error_end_date"></span>
                            </div>
                        </div>
                    </div>
                    <div class="form-group mb-3">
                        <label for="desc" class="mb-2">Keterangan <span class="text-info">(Bisa dikosongkan)</span></label>
...
@push('js')
    <script>
        ...
        $("#addBtn").click(function() {
            $(".modal-title").html("Ajukan Permohonan Izin/Cuti");
            $("#tipe").val("");
            $("#start_date").val("");
            $("#end_date").val("");
            $("#desc").val("");
        ...
        function editModal(id) {
            ...
            $.ajax({
                ...
                $(".modal-title").html("Edit Pengajuan Izin/Cuti");
        ...
        function approved(id) {
            Swal.fire({
                title: "Peringatan !",
                text: "Anda yakin ingin menerima pengajuan izin/cuti ini?",
                icon: "warning",
                showCancelButton: true,
                confirmButtonColor: "#3085d6",
                cancelButtonColor: "#d33",
        ...
        function rejected(id) {
            Swal.fire({
                title: "Peringatan !",
                text: "Anda yakin ingin menolak pengajuan izin/cuti ini?",
                icon: "warning",
                showCancelButton: true,
                confirmButtonColor: "#3085d6",
                cancelButtonColor: "#d33",
