            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group mb-3">
                        <label for="name" class="mb-2">Tanggal Pengajuan</label>
                        <input type="date" disabled value="{{date('Y-m-d')}}" class="form-control">
                    </div>
                    <div class="form-group mb-3">
                        <label for="title" class="mb-2">Keterangan Kasbon</label>
                        <input type="text" name="title" id="title" class="form-control">
                        <span class="invalid-feedback error_title"></span>
                    </div>
                    <div class="form-group mb-3">
                        <label for="amount" class="mb-2">Jumlah Penajuan Kasbon</label>
