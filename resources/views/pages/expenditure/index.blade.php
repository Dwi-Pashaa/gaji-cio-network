    ...
    <div class="card">
        ...
        <div class="card-footer d-flex align-items-center">
            <p class="m-0 text-secondary">
                Showing <span>{{ $expenditure->firstItem() }}</span> 
                to <span>{{ $expenditure->lastItem() }}</span> of
                <span>{{ $expenditure->total() }}</span> entries
            </p>
        ...
        <div class="modal-dialog modal-1 modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group mb-3">
                        <label for="type_id" class="mb-2">Tipe Pengeluaran</label>
                        ...
                        <span class="invalid-feedback error_type_id"></span>
                    </div>
                    <div class="form-group mb-3">
                        <label for="title" class="mb-2">Judul Pengeluaran</label>
...
@push('js')
<script>
    const BASE = "{{ route('expenditure.index') }}";
