    ...
    <div class="card">
        ...
        <div class="card-footer d-flex align-items-center">
            <p class="m-0 text-secondary">
                Showing <span>{{ $allowance->firstItem() }}</span> 
                to <span>{{ $allowance->lastItem() }}</span> of
                <span>{{ $allowance->total() }}</span> entries
            </p>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group mb-3">
                        <label for="name" class="mb-2">Nama Tunjangan</label>
                        <input type="text" name="name" id="name" class="form-control">
                        <span class="invalid-feedback error_name"></span>
                    </div>
                    <div class="form-group mb-3">
                        <label for="amount" class="mb-2">Jumlah Tunjangan</label>
...
@push('js')
<script>
    const BASE = "{{ route('allowance.index') }}";
