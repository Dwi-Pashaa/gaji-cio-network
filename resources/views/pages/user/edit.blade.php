            ...
            <div class="form-group mb-3">
                ...
                <select name="role" id="role" class="form-control @error('role') is-invalid @enderror">
                    ...
                    @foreach ($role as $item)
                        <option value="{{ $item->name }}" {{ isset($user->roles[0]) && $user->roles[0]->name == $item->name ? 'selected' : '' }}>{{ $item->name }}</option>
                    @endforeach
                </select>
                @error('role')
                    <span class="invalid-feedback">
                    ...
                    <div class="row g-3">
                            ...
                            <div class="form-group">
                                ...
                                <select name="bank_name" id="bank_name" class="form-select @error('bank_name') is-invalid @enderror">
                                    ...
                                    @foreach ($banks as $bCode => $bLabel)
                                        <option value="{{ $bCode }}" {{ old('bank_name', $user->bank_name) == $bCode ? 'selected' : '' }}>{{ $bLabel }}</option>
                                    @endforeach
                                </select>
                                @error('bank_name')
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            <div class="form-group">
                                ...
                                <input value="{{ old('account_number', $user->account_number) }}" type="text" name="account_number" id="account_number" class="form-control @error('account_number') is-invalid @enderror" placeholder="Contoh: 1234567890">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12">
                            <div class="form-group">
                                ...
                                <input value="{{ old('account_holder_name', $user->account_holder_name ?? $user->name) }}" type="text" name="account_holder_name" id="account_holder_name" class="form-control @error('account_holder_name') is-invalid @enderror" placeholder="Nama sesuai buku tabungan">
